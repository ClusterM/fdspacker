  ...
  "sides": [        // Array of disk sides. Can be >2 in case of multiple disks.
    {
      ...
      "unknown01": "$00",        // Optional unknown value at offset $16. Usually $00. Can be integer or HEX.
      "boot_file": "15",         // Boot read file code, Refers to the file code/file number to load upon boot/start-up. Can be integer or HEX.
      "unknown02": "$FF",        // Optional unknown value at offset $1A. Usually $FF. Can be integer or HEX.
      "unknown03": "$FF",        // Optional unknown value at offset $1B. Usually $FF. Can be integer or HEX.
      "unknown04": "$FF",        // Optional unknown value at offset $1C. Usually $FF. Can be integer or HEX.
      "unknown05": "$FF",        // Optional unknown value at offset $1D. Usually $FF. Can be integer or HEX.
      "unknown06": "$FF",        // Optional unknown value at offset $1E. Usually $FF. Can be integer or HEX.
      "manufacturing_date": "1987-04-17T00:00:00",  // Manufacturing date.
      "country_code": "Japan",   // Country code. Can be "Japan", integer or HEX.
      "unknown07": "$FF",        // Optional unknown value at offset $23. Usually $61. Speculative: Region code? Can be integer or HEX.
      "unknown08": "$FF",        // Optional unknown value at offset $24. Usually $00. Speculative: Location/site? Can be integer or HEX.
      "unknown09": "$FF",        // Optional unknown value at offset $25. Usually $00. Can be integer or HEX.
      "unknown10": "$FF",        // Optional unknown value at offset $26. Usually $02. Can be integer or HEX.
      "unknown11": "$00",        // Optional unknown value at offset $27. Speculative: some kind of game information representation? Can be integer or HEX.
      "unknown12": "$00",        // Optional unknown value at offset $28. Speculative: some kind of game information representation? Can be integer or HEX.
      "unknown13": "$00",        // Optional unknown value at offset $29. Speculative: some kind of game information representation? Can be integer or HEX.
      "unknown14": "$00",        // Optional unknown value at offset $2A. Speculative: some kind of game information representation? Can be integer or HEX.
      "unknown15": "$00",        // Optional unknown value at offset $2B. Speculative: some kind of game information representation? Can be integer or HEX.
      ...
      "unknown16": "$00",        // Optional unknown value at offset $2F. Can be integer or HEX.
      "unknown17": "$80",        // Optional unknown value at offset $30. Usually $80. Can be integer or HEX.
      "disk_writer_serial_number": "$FFFF",  // Disk Writer serial number. Can be integer (0-65535) or HEX ($0000-$FFFF).
      "unknown18": "$80",        // Optional unknown value at offset $33. Usually $07. Can be integer or HEX.
